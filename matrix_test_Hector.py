...
class MyTest1(unittest.TestCase):
    ...
    def test_add(self):
        ...
        self.assertEqual(m4.rows[0][1], 5)
        self.assertEqual(m4.rows[1][0], 6)
        self.assertEqual(m4.rows[1][1], 7)
    ...
    def test_sub(self):
        ...
        self.assertEqual(m4.rows[0][0], -2)
        self.assertEqual(m4.rows[0][1], -1)
        self.assertEqual(m4.rows[1][0], 0)
        self.assertEqual(m4.rows[1][1], 1)
