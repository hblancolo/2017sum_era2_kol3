...
class MyTest2(unittest.TestCase):
    ...
    def test_add(self):
        m3 = Matrix_representator(self.m1.add(self.m2))
    ...
    def test_multiply_with(self):
        m4 = Matrix_representator(self.m1.multiply_with(self.m2))
        self.assertEqual(m4.matrix_data[0][0],5)
        self.assertEqual(m4.matrix_data[0][1],5)
        self.assertEqual(m4.matrix_data[1][0],9)
        self.assertEqual(m4.matrix_data[1][1],9)
